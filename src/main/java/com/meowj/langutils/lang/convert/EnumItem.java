...
public enum EnumItem {
    ...
    BROWN_BED(Material.BED, 12, "item.bed.brown.name"),
    BLUE_BED(Material.BED, 11, "item.bed.blue.name"),
    PURPLE_BED(Material.BED, 10, "item.bed.purple.name"),
    CYAN_BED(Material.BED, 9, "item.bed.cyan.name"),
    LIGHT_GRAY_BED(Material.BED, 8, "item.bed.silver.name"),
    GRAY_BED(Material.BED, 7, "item.bed.gray.name"),
    PINK_BED(Material.BED, 6, "item.bed.pink.name"),
    LIME_BED(Material.BED, 5, "item.bed.lime.name"),
    YELLOW_BED(Material.BED, 4, "item.bed.yellow.name"),
    LIGHT_BLUE_BED(Material.BED, 3, "item.bed.lightBlue.name"),
    MAGENTA_BED(Material.BED, 2, "item.bed.magenta.name"),
    ORANGE_BED(Material.BED, 1, "item.bed.orange.name"),
    ...
    WHITE_GLAZED_TERRACOTTA(Material.WHITE_GLAZED_TERRACOTTA, "tile.glazedTerracottaWhite.name"),
    ORANGE_GLAZED_TERRACOTTA(Material.ORANGE_GLAZED_TERRACOTTA, "tile.glazedTerracottaOrange.name"),
    MAGENTA_GLAZED_TERRACOTTA(Material.MAGENTA_GLAZED_TERRACOTTA, "tile.glazedTerracottaMagenta.name"),
    LIGHT_BLUE_GLAZED_TERRACOTTA(Material.LIGHT_BLUE_GLAZED_TERRACOTTA, "tile.glazedTerracottaLightBlue.name"),
    YELLOW_GLAZED_TERRACOTTA(Material.YELLOW_GLAZED_TERRACOTTA, "tile.glazedTerracottaYellow.name"),
    LIME_GLAZED_TERRACOTTA(Material.LIME_GLAZED_TERRACOTTA, "tile.glazedTerracottaLime.name"),
    PINK_GLAZED_TERRACOTTA(Material.PINK_GLAZED_TERRACOTTA, "tile.glazedTerracottaPink.name"),
    GRAY_GLAZED_TERRACOTTA(Material.GRAY_GLAZED_TERRACOTTA, "tile.glazedTerracottaGray.name"),
    LIGHT_GRAY_GLAZED_TERRACOTTA(Material.SILVER_GLAZED_TERRACOTTA, "tile.glazedTerracottaSilver.name"),
    CYAN_GLAZED_TERRACOTTA(Material.CYAN_GLAZED_TERRACOTTA, "tile.glazedTerracottaCyan.name"),
    PURPLE_GLAZED_TERRACOTTA(Material.PURPLE_GLAZED_TERRACOTTA, "tile.glazedTerracottaPurple.name"),
    BLUE_GLAZED_TERRACOTTA(Material.BLUE_GLAZED_TERRACOTTA, "tile.glazedTerracottaBlue.name"),
    BROWN_GLAZED_TERRACOTTA(Material.BROWN_GLAZED_TERRACOTTA, "tile.glazedTerracottaBrown.name"),
    GREEN_GLAZED_TERRACOTTA(Material.GREEN_GLAZED_TERRACOTTA, "tile.glazedTerracottaGreen.name"),
    RED_GLAZED_TERRACOTTA(Material.RED_GLAZED_TERRACOTTA, "tile.glazedTerracottaRed.name"),
    BLACK_GLAZED_TERRACOTTA(Material.BLACK_GLAZED_TERRACOTTA, "tile.glazedTerracottaBlack.name"),
    BLACK_CONCRETE(Material.CONCRETE, 15, "tile.concrete.black.name"),
    RED_CONCRETE(Material.CONCRETE, 14, "tile.concrete.red.name"),
    GREEN_CONCRETE(Material.CONCRETE, 13, "tile.concrete.green.name"),
    BROWN_CONCRETE(Material.CONCRETE, 12, "tile.concrete.brown.name"),
    BLUE_CONCRETE(Material.CONCRETE, 11, "tile.concrete.blue.name"),
    PURPLE_CONCRETE(Material.CONCRETE, 10, "tile.concrete.purple.name"),
    CYAN_CONCRETE(Material.CONCRETE, 9, "tile.concrete.cyan.name"),
    LIGHT_GRAY_CONCRETE(Material.CONCRETE, 8, "tile.concrete.silver.name"),
    GRAY_CONCRETE(Material.CONCRETE, 7, "tile.concrete.gray.name"),
    PINK_CONCRETE(Material.CONCRETE, 6, "tile.concrete.pink.name"),
    LIME_CONCRETE(Material.CONCRETE, 5, "tile.concrete.lime.name"),
    YELLOW_CONCRETE(Material.CONCRETE, 4, "tile.concrete.yellow.name"),
    ...
    BROWN_CONCRETE_POWDER(Material.CONCRETE_POWDER, 12, "tile.concretePowder.brown.name"),
    BLUE_CONCRETE_POWDER(Material.CONCRETE_POWDER, 11, "tile.concretePowder.blue.name"),
    PURPLE_CONCRETE_POWDER(Material.CONCRETE_POWDER, 10, "tile.concretePowder.purple.name"),
    CYAN_CONCRETE_POWDER(Material.CONCRETE_POWDER, 9, "tile.concretePowder.cyan.name"),
    LIGHT_GRAY_CONCRETE_POWDER(Material.CONCRETE_POWDER, 8, "tile.concretePowder.silver.name"),
    GRAY_CONCRETE_POWDER(Material.CONCRETE_POWDER, 7, "tile.concretePowder.gray.name"),
    PINK_CONCRETE_POWDER(Material.CONCRETE_POWDER, 6, "tile.concretePowder.pink.name"),
    LIME_CONCRETE_POWDER(Material.CONCRETE_POWDER, 5, "tile.concretePowder.lime.name"),
    YELLOW_CONCRETE_POWDER(Material.CONCRETE_POWDER, 4, "tile.concretePowder.yellow.name"),
